...
public class JsonEventSerializerTest {
    ...
    private void assertEquals(EventMessage msg, String file) throws IOException, SerializationException {
        assertThatJson(serializer.write(msg))
                .when(Option.IGNORING_ARRAY_ORDER)
                .isEqualTo(Files.readString(Paths.get(file)));
    }
