...
import org.eclipse.digitaltwin.fa3st.common.dataformat.json.PathJsonSerializer;
...
import org.eclipse.digitaltwin.fa3st.common.serialization.json.util.Path;
...
public class PathJsonSerializerTest {
    ...
    @Test
    public void testProperty() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
    ...
    @Test
    public void testCollection() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
    ...
    @Test
    public void testCollectionWithParent() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
        Object input = new DefaultSubmodelElementCollection.Builder()
                .idShort(ID_COLLECTION_1)
                .value(new DefaultProperty.Builder()
                        .idShort(ID_PROPERTY_1)
    ...
    @Test
    public void testListProperty() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
    ...
    @Test
    public void testListComplex() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
    ...
    @Test
    public void testSubmodelEmpty() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
        Object input = new DefaultSubmodel.Builder()
    ...
    @Test
    public void testSubmodel() throws SerializationException, IOException, ValueMappingException, UnsupportedModifierException {
        Object input = new DefaultSubmodel.Builder()
                .idShort(ID_SUBMODEL_1)
                .submodelElements(new DefaultProperty.Builder()
                        .idShort(ID_PROPERTY_1)
    ...
    @Test
    public void testComplex() throws SerializationException, IOException, ValueMappingException, JsonProcessingException, UnsupportedModifierException {
        Object input = new DefaultSubmodel.Builder()
    ...
    private void assertEquals(IdShortPath parent, Object obj, Path path, Level level)
            throws SerializationException, JsonProcessingException, UnsupportedModifierException {
    ...
    private void assertEquals(IdShortPath parent, Object obj, Path path) throws SerializationException, JsonProcessingException, UnsupportedModifierException {
